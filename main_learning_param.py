...
if __name__=="__main__":
    ...
    parser.add_argument("-nb_hidden_neurons", help="Number of hidden neurons. Not used if linear type.", default="0", type=str)
    args=parser.parse_args()

    learning_param.execute(args.epochs, args.batchs, args.model_type, args.n_models,args.seed,args.output_name, args.optimizer,args.separation,args.nb_hidden_neurons)
