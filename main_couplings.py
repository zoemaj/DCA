...
if __name__=="__main__":
    ...
    parser.add_argument("L", help="length of the sequences in the MSA", type=int)
    parser.add_argument("K", help="number of categories in the MSA", type=int)
    ...
    couplings.couplings(args.model_name, args.L, args.K, args.number_models, args.type_average, args.output_name, args.figure, args.data_per_col, args.model_type)