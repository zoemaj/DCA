...
if __name__=="__main__":
    ...
    parser.add_argument("-output_name", help="Name for the output file. Default=path(input_name)/preprocessing_(threshold)gaps/preprocessed_(threshold)gaps.csv", default="",type=str)
